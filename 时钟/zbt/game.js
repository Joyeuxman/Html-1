...
define('FullScreen',['jquery', 'jquery.fullscreen'], function($){
// 全屏按扭
// box 全屏按扭放置的位置，即父元素
...
// 管理每一张图片上的“不同”数据
// 画圈及管理圆圈
define('Differences',['jquery'], function ($) {
...
;
// 控制倒计时
define('SecondManager',['jquery'], function ($) {
...
;
define('GameScene',['Scene','Differences', 'FullScreen', 'SecondManager', 'Label', 'TimeoutScene'], 
...
;
// 整体游戏控制
define('Game',['require','exports','module','jquery','Audio','StartScene','GameScene','GameSceneDatas','CompleteScene'],function (require, exports, module) {
    ...
    module.exports = function Game(box) {
        this.box = box
        // 创建音效对象，播放背景音乐
